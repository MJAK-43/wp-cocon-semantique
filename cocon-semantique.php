...
require_once CSB_PATH . 'includes/pront/class-csb-context-pront.php';
require_once CSB_PATH . 'includes/pront/class-prompt-context.php';
require_once CSB_PATH . 'includes/pront/trait-prompt-rules.php';
